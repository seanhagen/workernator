...
var serveCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		//*container.Image, error = wrangler.GetImage(ctx context.Context, source string)
		//*container.Container, error = wrangler.PrepImageForLaunch(img *container.Image)
		//wrangler.SetRootCommandName(cmdName string)
